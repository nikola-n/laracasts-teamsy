...
class TenantScopeTest extends TestCase
{
    ...
    /** @test */
    public function a_modal_has_tenant_id_on_the_migration()
    {
        ...
        //$now->year . '_' . $now->format('m') . '_' . $now->format('d') . '_' . $now->format('h') . $now->format('i')
        //. $now->format('s') . '_create_tests_table.php';
        ...
        //$this->assertFalse(File::exists(database_path('migrations/'.$filename)));
        //$this->assertStringContainsString('$table->unsignedBigInteger(\'tenant_id\')->index();',
